...
export default function EmailConfirmed() {
  ...
  useEffect(() => {
    async function confirmAndSignOut() {
      // Wait a moment for Supabase to process the session from URL hash
      await new Promise(r => setTimeout(r, 1500));
      // Sign out immediately — we don't want this device to be logged in
  ...
  if (!ready) {
    return (
      <div className="oria-page oria-page-center" style={{ gap: 16 }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 15 }}>Confirming your email...</p>
      </div>
    );
  }
